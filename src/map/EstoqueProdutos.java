...
public class EstoqueProdutos {
    ...
    public double calcularEstoque() {
        double produtoCalculado = 0;
        if (!estoqueMap.isEmpty()) {
            for (Produto c : estoqueMap.values()) {
                produtoCalculado = c.getQuantidade() * c.getPreco();
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Valor total do estoque: R$" + estoque.calcularEstoque());
